...
export default function SidebarComponent() {
  return (
    <div className="px-5 h-screen bg-white shadow-xl">
      {/* logo */}
      <div className="flex gap-3 items-center px-5 py-8 border-b-2 border-b-gray-200">
        <img
      ...
      {/* sidebar list */}
      <div className="px-5 pt-6 pb-20 w-full flex flex-col justify-between min-h-10/11">
        ...
        {/* render log out */}
        <div className="flex items-start gap-3 py-5 px-5 rounded-xl cursor-pointer hover:bg-gray-200">
          <LogOutIcon />
